        ...
        >
          ...
          <el-form-item label="Выберите категорию" prop="category">
            <a-cascader
              ...
              style="width: 100%"
            >
              <template slot="displayRender" slot-scope="{ selectedOptions }">
                <span
                  v-for="option in selectedOptions"
                  :key="option.id"
                  :value="option.value"
            ...
            <span class="text-[#a1a5bf]">Добавить товар в категорию</span>
          </el-form-item>
          ...
          <el-form-item label="Популярный" prop="popular">
            <el-switch v-model="categoryForm.isPopular"></el-switch>
          </el-form-item>
          ...
          <el-form-item label="Статус" prop="status">
            <el-select
              ...
              placeholder="Активный"
              @change="isCategoryStatus = !isCategoryStatus"
            >
              <el-option
                v-for="item in statuses"
                :key="item.value"
          ...
          >
            <!-- <el-select v-model="atrtibute" multiple placeholder="Select">
            <el-option
